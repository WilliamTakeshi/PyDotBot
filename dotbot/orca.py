...
from dotbot.vec2 import (
    Vec2, vec, add, sub, mul,
    dot, length_sq, vec2_length,
    normalize, perp
)
...
def compute_orca_line_pair(
    A: Agent, B: Agent, params: OrcaParams
) -> OrcaLine:
...
def intersect_lines(
    a: OrcaLine, b: OrcaLine,
    max_speed: float, v_pref: Vec2
) -> Vec2:
